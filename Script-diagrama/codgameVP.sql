...
--
-- Host: 127.0.0.1    Database: codgamedb
-- ------------------------------------------------------
...
CREATE TABLE `product` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(55) COLLATE utf8mb4_unicode_ci NOT NULL,
  `photo1` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `photo2` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `photo3` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Dump completed on 2022-07-14 16:31:06
